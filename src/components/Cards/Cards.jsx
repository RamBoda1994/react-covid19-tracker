    ...
    return (
        <div className={styles.container}>
            <Grid container spacing={3} justify="center">
                <Grid item component={Card} xs={12} md={3} elevation={6} className={cx(styles.card,styles.infected)}>
                    <CardContent>
                ...
                <Grid item component={Card} xs={12} md={3} elevation={6} className={cx(styles.card,styles.recovered)}>
                    <CardContent>
                ...
                <Grid item component={Card} xs={12} md={3} elevation={6} className={cx(styles.card,styles.deaths)}>
                    <CardContent>
